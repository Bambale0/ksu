...
.clinerules/skills/brainstorming/scripts/start-server.sh --project-dir /path/to/project --open
...
.clinerules/skills/brainstorming/scripts/start-server.sh --project-dir /path/to/project --open --foreground
```
...
bash .clinerules/skills/brainstorming/scripts/start-server.sh --project-dir /path/to/project --open --foreground
```
...
```bash
.clinerules/skills/brainstorming/scripts/start-server.sh \
