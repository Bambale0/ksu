...
export const api = {
  ...
  referralPromocodes: (limit = 100, offset = 0) => request<{ items: PartnerPromoCode[]; total: number; limit: number; offset: number }>(`/api/v1/referrals/promocodes?limit=${limit}&offset=${offset}`),
