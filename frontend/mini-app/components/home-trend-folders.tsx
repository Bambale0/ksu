...
export function HomeTrendFolders() {
  ...
  return createPortal(
    <section className={`home-trend-folders${selected ? " is-open" : ""}`} aria-label="Категории шаблонов">
      <style>{`
        .home-trend-folders{display:grid;gap:13px;margin:2px 0 26px;min-width:0}.home-trend-folders.is-open{position:fixed;z-index:70;inset:0 0 calc(92px + var(--tg-safe-bottom)) 0;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;margin:0;padding:calc(18px + var(--tg-safe-top)) max(14px,var(--tg-safe-right)) 28px max(14px,var(--tg-safe-left));background:#0b0b10;align-content:start;-webkit-overflow-scrolling:touch}.home-trend-folders-head{display:flex;align-items:end;justify-content:space-between;gap:12px}.home-trend-folders-copy{display:grid;gap:4px;min-width:0}.home-trend-folders-copy h2{margin:0;font-size:24px;line-height:1;letter-spacing:-.04em}.home-trend-folders-copy p{margin:2px 0 0;color:var(--muted);font-size:12px;line-height:1.4}.home-trend-folders-actions{display:flex;align-items:center;gap:8px;flex-shrink:0}.home-trend-folders-back{border:1px solid rgba(255,255,255,.11);background:#17131d;color:#fff;border-radius:999px;padding:8px 11px;font-weight:850}.home-trend-folders-admin{display:flex;justify-content:flex-end;gap:8px;flex-wrap:wrap;min-height:0}.home-trend-folder-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.home-trend-folder{position:relative;min-height:158px;overflow:hidden;border:1px solid rgba(190,117,255,.24);border-radius:23px;background:radial-gradient(circle at 80% 12%,rgba(170,74,255,.2),transparent 42%),linear-gradient(145deg,#15101e,#09070d);color:#fff;padding:0;text-align:left;box-shadow:0 16px 38px rgba(0,0,0,.2)}.home-trend-folder-preview{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.52}.home-trend-folder::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(5,3,9,.06),rgba(5,3,9,.9))}.home-trend-folder-card-copy{position:absolute;z-index:2;inset:auto 13px 13px;display:grid;gap:5px}.home-trend-folder-card-copy strong{font-size:18px;line-height:1.05}.home-trend-folder-card-copy small{color:rgba(255,255,255,.72);font-size:11px;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.home-trend-folder-meta,.home-trend-folder-item-meta{display:flex;gap:5px;flex-wrap:wrap}.home-trend-folder-meta span,.home-trend-folder-item-meta span{padding:5px 7px;border-radius:999px;border:1px solid rgba(225,192,255,.18);background:rgba(12,8,18,.62);color:#ead8f8;font-size:9px;font-weight:850}.home-trend-folder-tabs{display:grid;grid-template-columns:1fr 1fr;gap:7px;padding:4px;border:1px solid rgba(255,255,255,.08);border-radius:17px;background:#0c0a0f}.home-trend-folder-tabs button{min-height:42px;border:0;border-radius:13px;background:transparent;color:#9d95a7;font-weight:850}.home-trend-folder-tabs button.active{background:linear-gradient(135deg,rgba(159,72,255,.88),rgba(207,94,255,.82));color:#fff;box-shadow:0 8px 24px rgba(165,72,255,.18)}.home-trend-folder-items{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;overflow:visible;padding:2px 0 8px;min-width:0}.home-trend-folder-item{position:relative;aspect-ratio:3/4;min-height:0;min-width:0;overflow:hidden;border:1px solid rgba(185,105,255,.28);border-radius:22px;background:#0b0910;color:#fff;box-shadow:0 18px 42px rgba(0,0,0,.24)}.home-trend-folder-item-open{position:absolute;inset:0;width:100%;padding:0;border:0;background:transparent;color:inherit;text-align:left}.home-trend-folder-media{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;background:#0b0910}.home-trend-folder-item-open::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,.04) 28%,rgba(4,3,7,.88) 100%);pointer-events:none}.home-trend-folder-item-copy{position:absolute;z-index:2;left:14px;right:14px;bottom:14px;display:grid;gap:6px}.home-trend-folder-item-copy strong{font-size:18px;line-height:1.05}.home-trend-folder-item-copy small{color:rgba(255,255,255,.72);font-size:11px;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.home-trend-folders-empty{padding:17px;border:1px dashed rgba(190,130,255,.26);border-radius:20px;color:var(--muted);background:rgba(16,12,22,.72)}.home-trend-folders-error{padding:11px 13px;border-radius:14px;background:rgba(255,80,120,.1);color:#ffc6d3}@media(min-width:720px){.home-trend-folder-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.home-trend-folder-items{grid-template-columns:repeat(3,minmax(0,1fr))}}
      `}</style>
      ...
      {selected ? <div className="home-trend-folders-head">
        ...
        <div className="home-trend-folders-actions">
          <button className="home-trend-folders-back" type="button" onClick={() => { setSelectedId(""); setItems([]); }}>← Назад</button>
