...
export function HomeTrendFolders() {
  ...
  return createPortal(
    <section className="home-trend-folders" aria-label="Категории шаблонов">
      ...
      {!selected ? <div className="home-trend-folders-admin"><TrendCollectionAdmin onChanged={refreshCollections} /></div> : null}
    </section>,
    host,
  );
}
