    ...
    <section className="home-trend-folders" aria-label="Папки трендов по категориям">
      ...
      <div className="home-trend-folders-head">
        ...
        <div className="home-trend-folders-actions">
          {selected ? <button className="home-trend-folders-back" type="button" onClick={() => { setSelectedId(""); setItems([]); }}>← Папки</button> : null}
