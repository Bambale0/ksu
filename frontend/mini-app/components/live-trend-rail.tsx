...
function ensureHost(screen: HTMLElement): HTMLElement {
  ...
  const screenHead = screen.querySelector(".screen-head");
  if (screenHead?.nextSibling) screen.insertBefore(host, screenHead.nextSibling);
