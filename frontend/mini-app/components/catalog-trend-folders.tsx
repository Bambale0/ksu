  ...
  return createPortal(
    <section className="catalog-trend-folders" aria-label="Категории шаблонов">
      <style>{`
        ...
        .catalog-trend-folders .home-trend-folder-items{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;min-width:0;overflow:visible;padding:2px 0 8px}
        .catalog-trend-folders .home-trend-folder-item{position:relative;min-width:0;min-height:0;aspect-ratio:3/4;overflow:hidden;border:1px solid rgba(185,105,255,.28);border-radius:23px;background:#0b0910;color:#fff;box-shadow:0 18px 42px rgba(0,0,0,.24)}
