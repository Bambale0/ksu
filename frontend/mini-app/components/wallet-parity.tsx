...
export function WalletParity() {
  ...
  return createPortal(
    <div className="wallet-parity-link">
      ...
      <small>ЮKassa остаётся основным способом. Пакетный бонус уже включён в пакет. Активный промокод добавляет ещё +50 ROX после успешного пополнения от 1000 ₽.</small>
    </div>,
    host,
  );
}
