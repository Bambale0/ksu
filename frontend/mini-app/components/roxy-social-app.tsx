...
function transactionLabel(value?: string | null): string {
  const labels: Record<string, string> = {
    ...
    refund: "Возврат",
    bonus: "Бонус",
    partner_promo_welcome: "Старый бонус по промокоду",
    partner_promo_payment_bonus: "Бонус по промокоду за пополнение",
