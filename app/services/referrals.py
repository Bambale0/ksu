...
class ReferralService:
    ...
    async def accrue_from_payment(
        ...
        *,
        ...
        # The payment integration owns the commissionable basis. This is important
        # for top-up packages that credit operator-funded gift ROX in addition to
        # the purchased amount: gifts must never become withdrawable partner income.
