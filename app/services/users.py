    ...
    async def get_or_create(
        ...
        *,
        ...
        if user is not None:
            ...
            # Referral attribution is registration-only. A later startapp/share
            # link must never attach an already existing account, even when that
            # account currently has no referral relation.
            return user
