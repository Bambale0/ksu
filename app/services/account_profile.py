...
class AccountProfileService:
    ...
    def text(overview: dict[str, Any]) -> str:
        ...
        return (
            ...
            f"Пользователей 1-й линии: {partner['first_line']} · финансовые начисления только после активации промокода\n"
            f"Доступно к выводу: {partner['available_rub']} ₽ · в ожидании: {partner['pending_rub']} ₽\n\n"
            "👥 Социальное\n"
