...
MODEL_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "wan-2.7-video-edit": {"aspect_ratio": "16:9", "resolution": "1080p", "duration": 0, "audio_setting": "auto"},
    "wan-2.7-r2v": {"aspect_ratio": "16:9", "resolution": "1080p", "duration": 5},
    "seedance-1.5-pro": {"aspect_ratio": "16:9", "resolution": "720p", "duration": 8, "generate_audio": False, "fixed_lens": False, "nsfw_checker": False},
    ...
    "seedance-2.5": {"resolution": "720p", "aspect_ratio": "adaptive", "duration": 5, "output_format": "mp4", "generate_audio": False, "return_last_frame": False, "web_search": False, "nsfw_checker": False},
...
MODEL_FIELD_OVERRIDES: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "wan-2.7-video-edit": {"audio_setting": {"control": "combobox", "group": "output"}},
