...
def test_supplied_promo_artworks_are_bundled_and_mounted() -> None:
    ...
    assert '/mini-app/roxy-partner-promo.css?v=5' in brand
    assert '/mini-app/roxy-partner-promo.js?v=5' in brand
...
def test_home_promo_carousel_is_replaced_with_only_supplied_slides() -> None:
    ...
    assert 'image: "/mini-app/roxy-partner-referrals-slide.webp?v=5"' in script
