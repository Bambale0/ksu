...
def test_supplied_promo_artworks_are_bundled_and_mounted() -> None:
    ...
    assert '/mini-app/roxy-partner-promo.css?v=7' in brand
    assert '/mini-app/roxy-partner-promo.js?v=7' in brand


def test_home_promo_carousel_uses_only_supplied_raster_slides() -> None:
...
def test_supplied_slides_keep_artwork_crisp_in_compact_carousel() -> None:
