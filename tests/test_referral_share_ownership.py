...
def test_existing_user_referrer_is_never_assigned_by_later_share_link() -> None:
    ...
    assert "ReferralAntifraudService.attach_new_user" not in existing_branch
    assert "registration-only" in existing_branch
