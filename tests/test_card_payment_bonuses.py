...
@pytest.mark.asyncio
async def test_card_package_endpoint_exposes_configured_package_bonuses(
...
def test_wallet_stays_clean_while_payments_explains_package_and_promo_bonuses() -> None:
