...
def test_backend_referral_attribution_requires_telegram_signed_start_param() -> None:
    ...
    assert "_validated_startapp_inviter(session, signed_start_param or None)" in source
    assert source.index("_validated_startapp_inviter(session, signed_start_param or None)") < source.index(
