...
10. Approved visual assets belong in the repository or documented asset mirror. User-approved artwork must not be generatively reconstructed when exact preservation is required.
